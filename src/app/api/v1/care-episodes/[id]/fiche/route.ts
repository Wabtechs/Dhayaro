...
export async function GET(
  ...
  try {
    ...
    if (!validId) return apiErrorResponse('VALIDATION_ERROR', 422, { episodeId: "L'identifiant de l'épisode est invalide." })
...
return handleEndpointError(e, 'GET /care-episodes/[id]/fiche')
  }
}
