...
import { addFacilityFilter, enforceFacilityAccess, handleEndpointError, parsePagination } from '@/lib/api-errors'
...
return handleEndpointError(e, 'GET /partner-companies')
  }
}
...
createdAt: now,
    ...
    return handleEndpointError(e, 'POST /partner-companies')
  }
}